...
const Login = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-graphite-50 via-pure-white to-electric-blue/5 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      {/* Background amélioré avec performance optimisée */}
      <div className="absolute inset-0 opacity-20">
        <motion.div className="absolute top-10 sm:top-20 left-10 sm:left-20 w-48 h-48 sm:w-72 sm:h-72 bg-electric-blue/10 rounded-full blur-3xl" animate={{
        scale: [1, 1.1, 1],
        opacity: [0.3, 0.5, 0.3]
      }} transition={{
        duration: 8,
        ...
        <motion.div className="absolute bottom-10 sm:bottom-20 right-10 sm:right-20 w-64 h-64 sm:w-96 sm:h-96 bg-emerald-500/10 rounded-full blur-3xl" animate={{
        scale: [1, 1.2, 1],
        opacity: [0.2, 0.4, 0.2]
      }} transition={{
        duration: 10,
      ...
      <motion.div className="w-full max-w-md relative z-10" variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.div variants={itemVariants} className="mb-6 sm:mb-8">
          <Link to="/" className="inline-flex items-center text-graphite-600 hover:text-electric-blue transition-all duration-300 group text-sm sm:text-base">
        ...
        <motion.div variants={itemVariants}>
          <Card className="shadow-2xl border-0 bg-pure-white/90 backdrop-blur-lg">
            <CardHeader className="text-center pb-4">
              {/* Logo animé optimisé */}
              <motion.div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-electric-blue to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 relative" whileHover={{
              scale: 1.05
            }} transition={{
              type: "spring",
              stiffness: 300,
              damping: 30
                ...
                <motion.div className="absolute inset-0 rounded-full border-2 border-electric-blue/20" animate={{
                scale: [1, 1.2, 1],
                opacity: [0.3, 0, 0.3]
              }} transition={{
                duration: 2,
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <AnimatePresence mode="wait">
                  <TabsContent value="login" className="space-y-5 sm:space-y-6">
                    <motion.div key="login" variants={tabVariants} initial="hidden" animate="visible" exit="hidden" transition={{
                    duration: 0.3
                  }}>
                  ...
                  <TabsContent value="register" className="space-y-5 sm:space-y-6">
                    <motion.div key="register" variants={tabVariants} initial="hidden" animate="visible" exit="hidden" transition={{
                    duration: 0.3
                  }}>
