...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gray-100/80 p-1 text-gray-600 shadow-sm border border-gray-200/50",
      className
    )}
    {...props}
  />
