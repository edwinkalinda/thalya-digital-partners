      ...
      >
        {conversation.map((msg, index) => (
          ...
          >
            ...
            <div className={cn(
              ...
              {msg.role === 'ai' ? (
                logoImageData ? (
                  ...
                  <div className="w-4 h-4 sm:w-5 sm:h-5 bg-pure-white rounded-full"></div>
                )
              ) : (
            ...
            {/* Message */}
            <div className={cn(
              "max-w-[75%] sm:max-w-xs lg:max-w-md xl:max-w-lg",
              msg.role === 'user' ? "text-right" : "text-left"
            )}>
              <div className={cn(
                "inline-block p-3 sm:p-4 rounded-2xl shadow-sm",
                msg.role === 'ai'
