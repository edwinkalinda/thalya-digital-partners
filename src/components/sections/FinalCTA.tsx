      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="animate-fade-in">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="text-electric-blue font-semibold text-lg">L'avenir commence maintenant</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-graphite-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Rejoignez les entreprises visionnaires qui ont déjà fait le choix de l'excellence 
            avec Thalya. Votre première IA vous attend.
          </p>
          ...
          <div className="mt-16 pt-12 border-t border-graphite-800">
            <p className="text-graphite-500 mb-8">Déjà adopté par plus de 500 entreprises</p>
